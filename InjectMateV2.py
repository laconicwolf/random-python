...
class BurpExtender(IBurpExtender, ITab, swing.JFrame):
    def registerExtenderCallbacks(self, callbacks):
        ...
        # Second row
        tmpPanel.add(swing.JCheckBox("TBD", False, actionPerformed=self.handleOtherSelectCheckBox))
        tmpPanel.add(swing.JCheckBox("TBD", False, actionPerformed=self.handleOtherSelectCheckBox))
        tmpPanel.add(swing.JCheckBox("TBD", False, actionPerformed=self.handleOtherSelectCheckBox))
        ...
        tmpPanel.add(swing.JCheckBox("TBD", False, actionPerformed=self.handleOtherConfigCheckBox))
        tmpPanel.add(swing.JLabel("TODO CALLBACK SERVER :     ", swing.SwingConstants.RIGHT))
        self.otherCallbackServerTextArea = swing.JTextField('', 15)
        tmpPanel.add(self.otherCallbackServerTextArea)   
